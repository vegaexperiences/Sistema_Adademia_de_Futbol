-- Add payment thank you email template
-- This template is used for all payment types (ACH, card, Yappy, PagueloFacil)
-- Focus on gratitude and confirmation
...
WHERE NOT EXISTS (
  SELECT 1 FROM email_templates WHERE name = 'payment_thank_you'
);
