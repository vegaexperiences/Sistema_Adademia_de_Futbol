...
export function EditTutorModal({ tutor }: EditTutorModalProps) {
        ...
        >
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Modifica todos los datos del tutor
              {tutor.type === 'Family' && ' (afecta a todos los jugadores de la familia)'}
              {tutor.type === 'Individual' && tutor.playerIds && ` (afecta a ${tutor.playerIds.length} jugador${tutor.playerIds.length > 1 ? 'es' : ''})`}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className={tutor.type === 'Family' ? 'md:col-span-2' : ''}>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                  ...
                  <p className="mt-1 text-xs text-gray-600">
                    ...
                    {tutor.type === 'Family' && ' Este número se usará para todos los jugadores de esta familia.'}
                    {tutor.type === 'Individual' && tutor.playerIds && ` Este número se usará para ${tutor.playerIds.length} jugador${tutor.playerIds.length > 1 ? 'es' : ''}.`}
                  </p>
                </div>
              </div>
            </div>
