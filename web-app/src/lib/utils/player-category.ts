...
export function getCategoryColor(category: PlayerCategory): string {
  const colors: Record<PlayerCategory, string> = {
    'U6': 'bg-pink-100 text-pink-700',
    'U8': 'bg-purple-100 text-purple-700',
    'U10': 'bg-blue-100 text-blue-700',
    'U12': 'bg-green-100 text-green-700',
    'U14': 'bg-yellow-100 text-yellow-700',
    'U16': 'bg-orange-100 text-orange-700',
    'U18': 'bg-red-100 text-red-700',
    'Sin categoría': 'bg-gray-100 text-gray-700',
  };
